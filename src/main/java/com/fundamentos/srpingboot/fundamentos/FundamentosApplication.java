...
public class FundamentosApplication implements CommandLineRunner {
	...
	private void getInformationJpqlFromUSer(){
		...
		LOGGER.info("usuario con Query metodo findByEmailAndName " + userRepository.findByEmailAndName("camilo@hotmail.com", "Camilo").orElseThrow(() -> new RuntimeException("usuraio no encontrado")));
	}

	private void savesUserInDataBase(){
		User user1 = new User("Camilo", "camilo@hotmail.com", LocalDate.of(2023, 12, 17));
		User user2 = new User("Brayant", "Brayant@hotmail.com", LocalDate.of(2023, 11, 5));
		...
		User user9 = new User("Anderson", "Anderson@hotmail.com", LocalDate.of(2023, 4, 26));
		User user10 = new User("Andres", "Andres@hotmail.com", LocalDate.of(2023, 3, 19));
